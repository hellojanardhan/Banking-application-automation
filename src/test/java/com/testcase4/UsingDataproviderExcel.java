...
public class UsingDataproviderExcel 
{
	...
	public void login(String uid,String password) throws InterruptedException, IOException 
	{
		...
		driver.findElement(By.name("btnLogin")).click();
			...
			try {
				...
				alert.accept();
				if (alertMsg.contains(acutalAlertMsg)) {
...
//			File DestFile=new File("../AutomationBankingApplication/screenShots/img1.jpg");
